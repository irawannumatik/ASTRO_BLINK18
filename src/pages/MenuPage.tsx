...
const menuItems = [
  ...
  { label: "LATIHAN MANDIRI", icon: ClipboardList, path: "/latihan-mandiri", desc: "Latihan soal per kelas" },
  { label: "PERMAINAN", icon: Gamepad2, path: "/quiz-gamez", desc: "Quiz berdasarkan materi" },
